 ...
 */
/** export keywork added to be compatible with stimulus */
...
/** variable initialization commented for stimulus compatibility */
...
export const onFirstLoad = (sidebarEL) => {
    /** if statement commented for stimulus compatibility */
    // if (!sidebarEl) return
    if (isDesktop(window)) {
...
/** Block commented for stimulus compatibility */
